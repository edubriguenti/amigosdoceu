    ...
    <Layout>
      ...
      >
        <section className="py-12">
          ...
          <div className="max-w-4xl mx-auto mb-12">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              <div className="bg-accent-50 border border-accent-200 rounded-lg p-6 text-center">
                ...
                <h3 className="font-serif text-lg mb-2">Descubra</h3>
              ...
              <div className="bg-secondary-50 border border-secondary-200 rounded-lg p-6 text-center">
                <div className="text-4xl mb-2">🎯</div>
                <h3 className="font-serif text-lg mb-2">Colecione</h3>
                <p className="text-sm text-gray-600">
              ...
              <div className="bg-amber-50 border border-amber-200 rounded-lg p-6 text-center">
                <div className="text-4xl mb-2">📚</div>
                <h3 className="font-serif text-lg mb-2">Aprenda</h3>
                <p className="text-sm text-gray-600">
          ...
          <div className="mb-8">
            <h2 className="text-3xl font-serif mb-6">Suas Coleções</h2>
          ...
          <div className="bg-gradient-to-r from-primary-100 to-amber-50 rounded-lg p-8 text-center border border-secondary-200">
