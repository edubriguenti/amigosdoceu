...
import { getCelebracaoDoDia, getSantosPorSlugs, getProximasCelebracoes } from './calendarUtils'
...
export function montarDia(iso) {
  ...
  return {
    data: iso,
    celebracao: cel
      ? { nome: cel.nome, tipo: cel.tipo, descricao: cel.descricao, cor: cel.cor || null }
      : null,
